    ...
    <div style={{ backgroundColor: '#eaeded', minHeight: '100vh' }} className="dark:bg-black">
      ...
      {menuOpen && (
        <>
          ...
          <div style={{ position: 'fixed', top: '20px', left: '12px', width: '320px', height: 'auto', maxHeight: '80vh', backgroundColor: '#f3f3f3', zIndex: 50, overflow: 'auto', animation: 'slideInLeft 0.3s ease-out', borderRadius: '20px' }} className="dark:bg-[#1c1c1e]">
